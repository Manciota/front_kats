...
<article id="artigo">
      ...
      <div className="culado">
        ...
        <div className="branco">
            <div>
                <img className="gatoTop" src={require('../imagens/gatoTop.png')}/> 
            </div>
          <h1 className="adotar">
            Porque Adotar?
          </h1>
          <p id="texto"> Todos os pets merecem uma vida digna, regada com muito amor e proteção. Por esse motivo, ao concretizar uma adoção responsável você está proporcionado uma vida de mais qualidade para o pet.
...
<div>
<img className="gato-bottom" src={require('../imagens/gatopng.png')}/>
</div>
<div className="botao">
    <button id="botaoAdotar" onClick = {handleRedirect} >Quero Adotar</button>
</div>
